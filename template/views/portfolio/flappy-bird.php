            ...
            <section class="container container-space margin-top">
                ...
                <article class="line line-space">
                    ...
                    <div class="m6col col-space">
                        ...
                        <p><strong>Infelizmente esse jogo não funciona corretamente em dispositivos moveis (tablets e smartphones) por uma pequena incompatibilidade com algumas bibliotecas e com algumas ações do jogo</strong>.</p>
                    ...
                    <p style="font-size: .8em">* Para jogar use a tecla "barra de espaço" e/ou clique do mouse "botão esquerdo". </p>
                </article>
            </section>
