            ...
            <section class="container container-space margin-top">
                ...
                <article class="line line-space">
                    ...
                    <div class="m6col col-space">
                        ...
                        <p>Toda a interface do meu site "<a title="Home page" href="<?php echo route('/') ?>">leobcastro.com.br</a>" foi desenvolvida com o Bootstylle. Ele me fornece tudo que preciso para criar sites fluidos e responsivos (acessivel a dispositivos móveis).</p>
