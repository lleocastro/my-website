            ...
            <section class="container container-space margin-top">
                ...
                <article class="line line-space">
                    ...
                    <div class="m6col col-space">
                        ...
                        <p>O layout é simples e amigável (<a href="<?php echo route('portfolio/framework-css') ?>">desenvolvido com meu framework CSS</a>) para que qualquer pessoal possa navegar sem dificuldades, além disso, toda a estrutura é semanticamente correta com uma arquitetura de informações bem estruturadas e organizadas para tornar o site mais pratico de usar.</p>
            ...
            <section class="container">
                <article class="line line-space">
                    <div class="m6col col-space">
                        ...
                        <p>É possivel ver e manipular os e-mails (<em class="text-normal">captura de e-mails</em>) e mensagens que os visitantes deixam no site, podendo responde-los ou adiciona-los em alguma lista para nutrição de leads (<em class="text-normal">marketing de conversão</em>).</p>
                    ...
                    <div class="collist col-space">
                        <p class="info-text">*Esse painel de controle (<a title="Página do projeto" href="https://github.com/lleocastro/site-manager" rel="nofollow">dashboard</a>) é um projeto novo que estou desenvolvendo, para tornar a gestão de sites simples e trivial.</p>
                    </div>
                </article>
            </section>
