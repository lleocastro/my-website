...
<head>
    ...
    <title>Léo B. Castro - Portfólio - LEOBCASTRO</title>
</head>
<body>
        ...
        <section class="container container-space margin-top">
            ...
            <article class="line line-space">
                <div class="m6col col-space center">
                    <img title="Home page" src="<?php echo asset('img/leobcastro-print.png') ?>" alt="Website do Léo B. Castro aberto em um mac"/>
                </div>
