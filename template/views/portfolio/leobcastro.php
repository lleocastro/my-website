            ...
            <section class="container">
                <article class="line line-space">
                    <div class="m6col col-space">
                        ...
                        <p>Com o meu <em class="text-normal">dashboard</em> é possivel <em class="text-normal">gerenciar o site</em> e todo o seu conteúdo, atravéz de qualquer dispositivo com internet.</p>
                        ...
                        <p><strong>Esse <em class="text-normal">dashboard possui uma interface bem simples</em> para que qualquer pessoa sem conhecimento técnico consiga facilmente utiliza-lo</strong>.</p>
