            ...
            <section class="container container-space margin-top">
                ...
                <article class="line line-space">
                    ...
                    <div class="m6col col-space">
                        ...
                        <p><strong>"Aliás todos os meus sites são compativeís com esses dispositivos. 😉</strong></p>
                        <p>Atualmente o XNotes não está online (não está em produção), então não é possivel acessar a aplicação, mas é possivel ver o projeto no meu github.</p>
